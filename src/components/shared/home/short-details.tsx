...
const ShortDetails = () => {
  return (
    <div className="rounded-sm shadow-sm overflow-hidden md:mt-0 mb-5 bg-white">
      <h2 className="text-xl font-semibold bg-[#006A4E] text-center text-white py-1">
        রামপুর বাজার মজিদিয়া উচ্চ বিদ্যালয়
      </h2>
      <div className="p-2 grid grid-cols-1 md:grid-cols-2 gap-3 items-center">
        <div className="h-full rounded-lg bg-gray-100 overflow-hidden">
          <Image
            src="/images/img.jpg"
            alt="Brand Image"
