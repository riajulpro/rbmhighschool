...
import type { IVacancy, FormField } from "@/types/index";

const columns: ColumnDef<IVacancy>[] = [
  {
    accessorKey: "serial",
    header: ({ column }) => {
      return (
...
interface FacilityTableProps {
  data: IVacancy[];
  onAdd: (
    facility: Omit<IVacancy, "_id" | "createdAt" | "updatedAt">
  ) => Promise<void>;
  onEdit: (id: string, facility: Partial<IVacancy>) => Promise<void>;
